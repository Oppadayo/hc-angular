...
@Component({
  selector: 'app-paginadorm',
  templateUrl: './paginadorm.component.html',
  styleUrls: ['./paginadorm.component.css']
})
export class PaginadormComponent implements OnInit, OnChanges {
